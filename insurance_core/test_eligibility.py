...
from insurance_core.eligibility import (
	EligibilityResult,
	_compare,
	_normalize_weights,
)
...
class TestEligibilityEngine(FrappeTestCase):
	def test_module_importable(self):
		from insurance_core.eligibility import evaluate_claim_eligibility, get_applicable_criteria
	...
	def test_builtin_kyc_and_policy_checks(self):
		from insurance_core.eligibility import _builtin_check
	...
	def test_mandatory_vs_optional_scoring(self):
		from insurance_core.eligibility import EligibilityResult, _normalize_weights
