...
def get_active_providers():
	from insurance_core.insurance_core.doctype.insurance_provider.insurance_provider import get_active_providers as _fn
...
def get_active_schemes(scheme_type=None):
	from insurance_core.insurance_core.doctype.insurance_scheme.insurance_scheme import get_active_schemes as _fn
...
def apply_endorsement(name):
	from insurance_core.insurance_core.doctype.policy_endorsement.policy_endorsement import apply_endorsement as _fn
