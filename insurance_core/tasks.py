...
def send_renewal_reminders():
	from insurance_core.insurance_core.doctype.insurance_policy.insurance_policy import send_expiry_reminders
...
def send_premium_reminders():
	from insurance_core.insurance_core.doctype.insurance_policy.insurance_policy import send_premium_reminders as _send

	_send()


def expire_policies():
	from insurance_core.insurance_core.doctype.insurance_policy.insurance_policy import expire_policies as _expire
...
def rescore_open_claims():
	from insurance_core.eligibility import rescore_open_claims as _rescore
